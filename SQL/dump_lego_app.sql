...
INSERT INTO `color` (`color_id`, `hex_code`, `name_en`, `name_fr`) VALUES
(1, '05131D', 'Black', 'Noir'),
(2, '237841', 'Green', 'Vert'),
(3, '008F9B', 'Dark Turquoise', ''),
(4, 'C91A09', 'Red', 'Rouge'),
(5, 'C870A0', 'Dark Pink', ''),
(6, '583927', 'Brown', 'Marron'),
(7, '9BA19D', 'Light Gray', 'Gris clair'),
(8, '6D6E5C', 'Dark Gray', 'Gris foncé'),
(9, 'B4D2E3', 'Light Blue', 'Bleu clair'),
(10, '4B9F4A', 'Bright Green', ''),
(11, '55A5AF', 'Light Turquoise', ''),
(12, 'F2705E', 'Salmon', ''),
(13, 'FC97AC', 'Pink', 'Rose'),
(14, 'F2CD37', 'Yellow', 'Jaune'),
(15, 'FFFFFF', 'White', 'Blanc'),
(17, 'C2DAB8', 'Light Green', 'Vert clair'),
(18, 'FBE696', 'Light Yellow', ''),
(19, 'E4CD9E', 'Tan', ''),
(20, 'C9CAE2', 'Light Violet', ''),
(21, 'D4D5C9', 'Glow In Dark Opaque', ''),
(22, '81007B', 'Purple', 'Pourpre'),
(23, '2032B0', 'Dark Blue-Violet', ''),
(25, 'FE8A18', 'Orange', 'Orange'),
(26, '923978', 'Magenta', 'Magenta'),
(27, 'BBE90B', 'Lime', ''),
(28, '958A73', 'Dark Tan', ''),
...
(288, '184632', 'Dark Green', 'Vert foncé'),
...
--
-- Déchargement des données de la table `country_names`
--

INSERT INTO `country_names` (`country_code`, `name_en`, `name_fr`) VALUES
('AT', 'Austria', 'Autriche'),
...
--
-- Index pour la table `country_names`
--
